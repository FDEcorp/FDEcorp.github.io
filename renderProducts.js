            ...
            function(product){
                ...
                <div class="product" id="${product.key}-card">
                    <div ondblclick="removeItem('${product.key}')" style="height:70px; margin: 6px; border-radius: 6px; display: flex; flex-direction: row;">
                        ...
                        <div class="wrap" style="width: 50%; font-weight:800; font-size:16px; color: Black; width: 100px; text-align: left; width: 50%; padding: 4px; display: flex; align-items: center;">${String(product.key).replaceAll('_',' ')}</div>
                    </div>
